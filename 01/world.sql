...
# Database: world
# Generation Time: 2011-06-14 15:57:37 +0200
# ************************************************************
...
# Dump of table habprsqmtr
# ------------------------------------------------------------

DROP VIEW IF EXISTS `habprsqmtr`;

CREATE TABLE `habprsqmtr` (
   `Name` CHAR(52) NOT NULL DEFAULT '',
   `total` DOUBLE(17) DEFAULT NULL
) ENGINE=MyISAM;;
...
DROP TABLE `habprsqmtr`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `habprsqmtr`
AS select
   `country`.`Name` AS `Name`,(`country`.`Population` / `country`.`SurfaceArea`) AS `total`
from `country`;
