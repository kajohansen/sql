...
CREATE TABLE `City` (
  ...
  PRIMARY KEY  (`ID`)
) TYPE=MyISAM AUTO_INCREMENT=4080 ;
...
(330, 'Santa Brbara dOeste', 'BRA', 'S¿?o Paulo', 171657),
...
(426, 'So Jos de Ribamar', 'BRA', 'Maranhï¿?o', 98318),
...
(455, 'guas Lindas de Gois', 'BRA', 'Goiï¿?s', 89200),
