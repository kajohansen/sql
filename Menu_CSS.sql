...
-- 
-- Host: localhost
-- Generation Time: Dec 26, 2006 at 11:34 PM
...
CREATE TABLE `menu_mnu` (
  ...
  KEY `visible_mnu` (`visible_mnu`),
  KEY `idmnu_mnu` (`idmnu_mnu`)
...
INSERT INTO `menu_mnu` (`id_mnu`, `idmnu_mnu`, `label_mnu`, `tooltip_mnu`, `order_mnu`, `visible_mnu`, `url_value_mnu`, `target_mnu`) VALUES (1, NULL, 'Home', 'Home page', 1, 1, 'home', '_self'),
(2, NULL, 'Spring Pack', 'Products in MX Spring Pack 2006', 2, 1, 'spring', '_self'),
(3, NULL, 'Company', 'Company', 3, 1, '', '_self'),
(4, 2, 'MX RSS Reader-Writer', 'MX RSS Reader-Writer', 4, 1, 'prod&id_prd=1', '_self'),
(5, 2, 'MX Site Search', 'MX Site Search', 5, 1, 'prod&id_prd=2', '_self'),
(6, 2, 'MX Looper', 'MX Looper', 6, 1, 'prod&id_prd=3', '_self'),
(7, 2, 'MX Dynamic Table Sorter', 'MX Dynamic Table Sorter', 7, 1, 'prod&id_prd=4', '_self'),
(8, 2, 'MX Calendar', 'MX Calendar', 8, 1, 'prod&id_prd=5', '_self'),
(9, 2, 'MX CSS Dynamic Menus', 'MX CSS Dynamic Menus', 9, 1, 'prod&id_prd=6', '_self'),
(10, 2, 'MX Navigation Pack', 'MX Navigation Pack', 10, 1, 'prod&id_prd=7', '_self'),
(11, 3, 'Overview', 'Company overview', 11, 1, 'overview', '_self'),
(12, 3, 'Contact', 'Contact', 12, 1, 'contact', '_self');
